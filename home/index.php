...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/MaterialDesign-Webfont/2.0.46/css/materialdesignicons.css" integrity="sha256-snZ0BFhOCNB7Mw15J65uW3noOMhUmuZwzLDJF8l2EiM=" crossorigin="anonymous" />
    <link rel="stylesheet" href="../public/css/style.css">
    <title>Chat App</title>
</head>

<body>
    <input type="hidden" id="txtID" value="<?= $_SESSION["id"] ?>">
    <header class="top-bar">
        <div class="logo">
            <!-- <a id="btnContactos" onclick="" class="text-white"><span
                    class="mdi mdi-account-multiple mdi-36px"></span></a> -->
            <a id="btnContactos" onclick="" class="hover-cursor text-white"><span class="mdi mdi-exit-to-app mdi-36px"></span></a>
            <a id="myBtn" class="hover-cursor text-white"><span class="mdi mdi-account-settings-variant mdi-36px"></span></a>
        </div>
        </div>
        <div class="perfiles">
    ...
    <div class="container mensajes" id="divMensajes">
